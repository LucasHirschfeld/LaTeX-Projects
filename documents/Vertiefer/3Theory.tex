...
where $\phi_\mathrm{sample}$ is the work function of the sample. The kinetic energy of the photoelectron is defined as:

\begin{equation}
	\label{eq:KineticEnergy}
	E_\mathrm{kin} = E_\mathrm{\gamma} - E_\mathrm{B} - \phi_\mathrm{analyzer},
\end{equation}

where $E_\mathrm{\gamma}$ is the photon energy and $E_\mathrm{B}$ is the binding energy of the electron.
