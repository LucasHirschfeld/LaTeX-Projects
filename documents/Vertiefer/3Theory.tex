...
The kinetic energy of the photoelectron measured by the analyzer is relative to the Fermi level $E_\mathrm{F}$ and given by:
...
where $E_\mathrm{kin}$ is the kinetic energy of the photoelectron and $\phi_\mathrm{sample}$ is the work function of the sample. The kinetic energy of the photoelectron is defined as:
...
where $E_\mathrm{\gamma}=h\nu$ is the photon energy and $E_\mathrm{B}$ is the binding energy of the electron.
...
As seen in \autoref{eq:BindingEnergy}, $E_\mathrm{B}$ of photoelectrons depends on initial and final state effects. This approximation is known as the \textit{Koopmans}' theorem.\autocite{Koopmans1934}
