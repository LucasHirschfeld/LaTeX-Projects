...
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.46\textwidth]{images/XPS_schematic.png}
...
As seen in \autoref{eq:BindingEnergy}, $E_\mathrm{B}$ of photoelectrons depends on initial and final state effects.
