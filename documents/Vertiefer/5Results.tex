...
\begin{figure}[H]
	...
	\caption{Overview of C1s \ac{XPS} spectra for monolayer preparation of the $\alpha$-phase of \ac{QA} on Ag(100) with a coverage between 0.08~\ac{ML} and 1.00~\ac{ML}. The line corresponds to the envelope of the fitted peaks and the circles are the measured data points.}
...
\begin{figure}[H]
	...
	\caption{C1s \ac{XPS} spectrum for the $\alpha$-phase of \ac{QA} on Ag(100) for a coverage of 1~\ac{ML} with the experimental data points, the fitted components and the resulting envelope.}
	\label{fig:C1s-alpha}
\end{figure}

The \ac{XPS} spectra for the C1s photoemission lines of \ac{QA} on Ag(100) reveals consistent spectral features. The main peak ($\mathrm{C_{arom}}$) contains contributions of the carbon atoms from the aromatic rings that are not part of the two rings containing the keto and the amine groups. Next, there is a peak for the two atoms next to the amine ($\mathrm{C_{NH}}$) and another peak for the two atoms next to the ketone ($\mathrm{C_{CO}}$). Finally, there is one peak for the carbonyl carbon atoms of the ketone ($\mathrm{C_{O}}$). The values corresponding to each peak can be found in \autoref{tab:C1s-alpha-fit}.
...
\begin{table}[H]
	...
	\begin{tabular}{@{}cccc@{}} \toprule
		...
		\midrule
		$\mathrm{C_{arom}}$ & 285.016 & 10 & 0.938 \\
		$\mathrm{C_{NH}}$ & 284.308 & 4 & 0.764 \\
		$\mathrm{C_{CO}}$ & 286.010 & 4 & 1.200 \\ 
		$\mathrm{C_{O}}$ & 286.723 & 2 & 1.152 \\
		\bottomrule
	\end{tabular}
...
\begin{figure}[H]
	...
	\caption{C1s \ac{XPS} spectrum for the $\alpha$-phase of \ac{QA} on Ag(100) for a mutlilayer coverage compared to the \ac{XPS} spectrum for a coverage of 1~\ac{ML} with the experimental data points, the fitted components and the resulting envelope.}
...
\begin{table}[H]
	\centering
	\caption{Fit parameter used in CasaXPS\autocite{CasaSoftwareLtd2022} for the multilayer $\alpha$-phase of \ac{QA} on Ag(100) for the C1s photoemission lines.}
	\begin{tabular}{@{}cccc@{}} \toprule
		peak & \ac{BE} / eV & area ratio & FWHM / eV \\
		\midrule
		$\mathrm{C_{arom}}$ &  & 10 &  \\
...
\begin{table}[H]
	...
	\begin{tabular}{@{}cccc@{}} \toprule
		peak & \ac{BE} / eV & area ratio & FWHM / eV \\
		\midrule
		$\mathrm{O1}$ & 530.657 & 2.00 & 1.360 \\
		$\mathrm{O1_{sat}}$ & 531.273 & 0.53 & 0.712 \\
		\bottomrule
	\end{tabular}
...
\begin{figure}[H]
	...
	\caption{N1s \ac{XPS} spectrum for the $\alpha$-phase of \ac{QA} on Ag(100) for a coverage of 1~\ac{ML} with the experimental data points, the fitted components and the resulting envelope.}
	\label{fig:N1s-alpha}
\end{figure}
...
\begin{table}[H]
	...
	\begin{tabular}{@{}cccc@{}} \toprule
		peak & \ac{BE} / eV & area ratio & FWHM / eV \\
		\midrule
		$\mathrm{N1}$ & 400.054 & 2.00 & 1.017 \\
		$\mathrm{N1_{damage}}$ & 397.656 & 0.31 & 1.160 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[H]
	\centering
	\caption{Fit parameter used in CasaXPS\autocite{CasaSoftwareLtd2022} for the multilayer $\alpha$-phase of \ac{QA} on Ag(100) for the N1s photoemission lines.}
	\begin{tabular}{@{}cccc@{}} \toprule
		peak & \ac{BE} / eV & area ratio & FWHM / eV \\
		\midrule
		$\mathrm{N1}$ &  &  &  \\
...
\begin{table}[H]
	...
	\begin{tabular}{@{}cccc@{}} \toprule
		peak & \ac{BE} / eV & area ratio & FWHM / eV \\
		\midrule
		$\mathrm{C_{arom}}$ & 284.545 & 10 & 1.132 \\
		$\mathrm{C_{NH}}$ & 284.275 & 4 & 0.618 \\ 
		$\mathrm{C_{CO}}$ & 285.322 & 4 & 1.107 \\
		$\mathrm{C_{O}}$ & 286.072 & 2 & 0.785 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{@{}cccc@{}} \toprule
		peak & \ac{BE} / eV & area ratio & FWHM / eV \\
		\midrule
		$\mathrm{O1}$ & 530.683 & 1 & 0.712 \\
		$\mathrm{O1_{sat}}$ & 531.661 & 0.05 & 0.362 \\
		$\mathrm{O2}$ & 530.186 & 1 & 0.681 \\
		$\mathrm{O2_{sat}}$ & 531.200 & 0.14 & 0.451 \\
		\bottomrule
	\end{tabular}
...
\begin{table}[H]
	...
	\begin{tabular}{@{}cccc@{}} \toprule
		peak & \ac{BE} / eV & area ratio & FWHM / eV \\
		\midrule
		$\mathrm{N1}$ & 399.865 & 1 & 0.774\\
		$\mathrm{N2}$ & 397.661 & 1 & 0.686 \\
		\bottomrule
	\end{tabular}
