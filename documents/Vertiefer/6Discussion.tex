...
The $\alpha$ and $\beta$-phase of \ac{QA} on Ag(100) were investigated using \ac{XPS} for three different components: C1s, O1s and N1s. The following discourse will examine the results obtained from \autoref{sec:results}, which will be divided in the same manner as the results section.

\section{The \texorpdfstring{$\alpha$}{alpha}-Phase}

The C1s \ac{XPS} spectra consist of four distinct components, corresponding to distinct types of carbon atoms in the \ac{QA} molecule, namely  $\mathrm{C_{arom}}$,  $\mathrm{C_{NH}}$,  $\mathrm{C_{CO}}$ and  $\mathrm{C_{O}}$.

The carbon atoms $\mathrm{C_{arom}}$ have the least influence from the functional groups. This leads to a \ac{BE} in the center of the spectrum. Due to the number of carbon atoms associated with this peak, the peak area is the most substantial, and the peak provides the primary contribution to the overall shape of the spectrum. The \ac{BE} of the peak appears to be realistic, as evidenced by the agreement of the \ac{BE} with that of other molecular adsorbates on Ag(100), such as \ac{PTCDA}, which exhibit comparable values.\autocite{Bauer2014} For \ac{PTCDA}, the \ac{BE} of the carbon atoms inside the ring is 284.91~\si{\eV}, which is very similar to the \ac{BE} of the $\mathrm{C_{arom}}$ peak (285.02~\si{\eV}) for \ac{QA}. In addition, the \ac{BE} of the corresponding peak in indigo (285.5~\si{\eV})\autocite{Brunet2011, Michels2021} is also very similar to the \ac{BE} of the $\mathrm{C_{arom}}$ peak in \ac{QA}.

The $\mathrm{C_{CO}}$ peak is located at a higher \ac{BE} than the $\mathrm{C_{arom}}$ peak, which is expected due to the electronegative oxygen atom. The \ac{BE} of the $\mathrm{C_{CO}}$ peak (286.01~\si{\eV}) is also in line with the literature, as it is similar to the \ac{BE} of carbon atoms next to a carbonyl groups in other molecular adsorbates, such as \ac{PTCDA} (285.47~\si{eV}).\autocite{Bauer2014}

The $\mathrm{C_{O}}$ peak is located at an even higher \ac{BE} than the $\mathrm{C_{CO}}$ peak, which is also expected due to the electronegative oxygen atom. The \ac{BE} of the $\mathrm{C_{O}}$ peak (286.72~\si{\eV}) is also in line with the literature, as it is similar but not as high as the \ac{BE} of carbonyl carbon atoms in \ac{PTCDA} (288.92~\si{eV})\autocite{Bauer2014} or in indigo (287.5~\si{eV})\autocite{Brunet2011, Michels2021}.
...
The \ac{XPS} spectra for the N1s component exhibit a single peak in the $\alpha$-phase. The \ac{BE} of the N1s peak (400.0~\si{\eV}) is in line with the literature, as it is similar to the \ac{BE} of nitrogen atoms in other molecular adsorbates, such as indigo (399.9~\si{eV}).\autocite{Xu2024}

The peak that arises due to beam damage ($\mathrm{N1_{damage}}$) has a shift towards smaller \ac{BE} of around 2.20~\si{\eV}. This large difference indicates a drastic change in the chemical environment of the nitrogen atoms. Compared to other shifts in the \ac{BE}, e.g. for the carbon atoms, the influence of other neighboring atoms are not enough to explain this change. For this reason, something different has to happen at the nitrogen atom due to beam damage.

A typical observed phenomena for the amine group is the deprotonation of the nitrogen atom. The deprotonation of amine groups in \ac{XPS} spectra was examined with a shift in the \ac{BE} of about 2-3~\si{\eV} for glyphosate and molecules similar to pyridine.\autocite{Kang1990, Ruano2021}  This matches to the results found for the $\mathrm{N1_{damage}}$ peak, leading to the assumption that the x-ray beam deprotonates some of the nitrogen atom.
...
It is noteworthy, that the carbon atoms in the $\mathrm{C_{NH}}$ peak are directly next to the nitrogen atoms. For the $\beta$-phase, two different nitrogen peaks are present, which should also lead to two different $\mathrm{C_{NH}}$ peaks. However, the $\mathrm{C_{NH}}$ peak could not be resolved into two different peaks.
