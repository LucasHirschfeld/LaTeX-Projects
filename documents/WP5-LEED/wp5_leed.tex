...
\def\Titel{Low Energy Electron Diffraction (LEED) of the Au(111) surface and PTCDA on the Au(111) surface}
...
As conclusion, the Au(111) surface reconstruction is observed in the \ac{LEED} experiments in this report and could be characterized by a (22x$\sqrt{3}$) superstructure. 
