...
The \ac{LEED} measurements were conducted in an \ac{UHV} chamber with a base pressure below $5 \cdot 10^{-10}$~\si{mbar}. The chamber was equipped with a turbomolecular pump and an ion getter pump. The sample was mounted on a sample holder that allowed for precise rotation and translation in all directions. As sample, a single crystal of Au(111) was used, which was chosen for its well-known surface structure. The sample holder was equipped with a resistive heating element to facilitate annealing procedures and a thermocouple for temperature measurement.
...
Afterwards, the diffraction pattern of the Au(111) surface was recorded at different electron energies, ranging from 80~\si{eV} to 200~\si{eV}. The diffraction patterns were analyzed to determine the spot distances and the lattice constant of the Au(111) surface. In addition, the reconstruction of the Au(111) surface was investigated by measuring the diffraction pattern. The \ac{LEED} patterns were analyzed to determine the Au(111) surface reconstruction.
...
The orientation of the Au(111) surface in the diffraction pattern in comparison to a hard-sphere model was determined using the \ac{LEED} pattern obtained at an electron energy of 179.3~\si{eV}. The diffraction spots were analyzed and compared to the expected positions of the diffraction spots for a perfect Au(111) surface. \autoref{fig:surface_orientations} shows the surface orientation of the Au(111) crystal structure in comparison to the hard-sphere model.
...
The spot distances in the \ac{LEED} pattern were measured to determine the distance $r$ between the Au(111) sample and the detector, which is equivalent to the screen radius. The distances between the diffraction spots were extracted from the \ac{LEED} patterns in \autoref{fig:leed_patterns_angle} recorded at the same electron energy of 119.6~\si{eV} but at different angles. The distances were measured in pixels.
...
The \ac{LEED} patterns of the Au(111) surface at different electron energies are shown in \autoref{fig:leed_patterns_energy}. The distances between the diffraction spots were measured in pixels and are summarized in \autoref{tab:spot_distances_energy}. The distances were measured from the center of the diffraction pattern to the center of the diffraction spots. For each electron energy, the distances were measured for six different diffraction spots and the average distance was calculated. The average distance is shown in the last row of \autoref{tab:spot_distances_energy}.
...
\begin{table}[htbp]
    ...
    \caption{Measured \ac{LEED} spot distances and calculated lattice parameters for Au(111) surface at different electron energies.}
                ...
                \hline
                \multirow{6}{*}{80.0} & \multirow{6}{*}{1.371} & \multirow{6}{*}{4.583} & 307.0 & $2.20 \pm 0.23$ & $3.29 \pm 0.35$ & $4.66 \pm 0.49$ \\
                ...
                \hline \hline
                \multirow{6}{*}{179.3} & \multirow{6}{*}{0.916} & \multirow{6}{*}{6.860} & 216.3 & $2.32 \pm 0.24$ & $3.12 \pm 0.33$ & $4.42 \pm 0.46$ \\
                ...
                \hline \hline
                \multirow{6}{*}{198.7} & \multirow{6}{*}{0.870} & \multirow{6}{*}{7.222} & 211.6 & $2.39 \pm 0.25$ & $3.03 \pm 0.32$ & $4.29 \pm 0.45$ \\
...
The superstructure matrix $\mathbf{M}$ is used to describe the positions of the additional diffraction spots in the \ac{LEED} pattern. In comparison with the literature\autocite{Kilian2002,Kilian2006}, the superstructure matrix $\mathbf{M}$ is consistent with the expected structure of \ac{PTCDA} on the Au(111) surface.
...
The reconstruction of the Au(111) surface is described by a (22x$\sqrt{3}$) superstructure. The reconstruction is characterized by the formation of additional diffraction spots in the \ac{LEED} pattern, which are not observed for unreconstructed surfaces. 
...
Nevertheless, the superstructure unit cell used is (11x$\frac{\sqrt{3}}{2}$), which leads to a smaller unit cell than the (22x$\sqrt{3}$) reconstruction. This could be explained by the fact that the second order spots are higher in intensity that the first order spots and therefore the second order spots are used to fit the superstructure matrix $\mathbf{M}$. This intensity difference with higher intensity for the second order spots could be explained by the fact that the second order spots have strong Fourier coefficients, as stated by Harten \textit{et al.}\autocite{Harten1985}.
